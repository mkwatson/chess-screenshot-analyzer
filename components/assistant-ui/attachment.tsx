...
const useFileSrc = (file: File | undefined) => {
  // Derive the object URL synchronously from `file` (no extra render) and
  // only schedule cleanup via the effect. This avoids the
  // react-hooks/set-state-in-effect rule while keeping resource cleanup.
